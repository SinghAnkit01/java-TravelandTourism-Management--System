...
import java.sql.*;
public class deletedetails extends JFrame implements ActionListener,Runnable {
    String user;
    JButton back;
    ...
    JLabel heading = new JLabel("DELETE CUSTOMER INFORMATION");
    ...
    public void run() {
       try {
        Thread.sleep(5000);
        JOptionPane.showMessageDialog(null,"Wait Records are being deleted " );
        Thread.sleep(3000);
        JOptionPane.showMessageDialog(null, "Data Deleted Successfully");
        // setVisible(false);
        System.exit(0);
